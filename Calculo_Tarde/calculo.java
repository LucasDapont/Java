...
public class calculo extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        float totalAbastecido = Float.parseFloat(request.getParameter("totalAbastecido"));
        float preco = Float.parseFloat(request.getParameter("preco"));
        float consumoMedio = Float.parseFloat(request.getParameter("consumoMedio"));
        
        
        float valor = totalAbastecido * preco;
        float distancia = totalAbastecido * consumoMedio;
